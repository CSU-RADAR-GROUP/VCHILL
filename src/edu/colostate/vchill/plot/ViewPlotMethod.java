...
//System.out.println("offset changed to " + xOffset + ", " + yOffset);
        this.offsetX = xOffset; this.offsetY = yOffset; }
    ...
    protected boolean outOfRange (final int[] xVals, final int[] yVals) { return false; }
    protected boolean outOfRange (final double startAngle, final double endAngle) { return false; }
    ...
    static class Angle
    {
        ...
        public double getSin () { return this.sin; }
        public double getCos () { return this.cos; }
...
//            }
    ...
    public void setClickPoint (final double azimuth, final double elevation, final double range) {
        this.clickAz = azimuth; this.clickEl = elevation; this.clickRng = range; }
    public double getClickAz () { return this.clickAz; }
    public double getClickEl () { return this.clickEl; }
    public double getClickRng () { return this.clickRng; }
    ...
    public boolean isExportable () { return false; }
