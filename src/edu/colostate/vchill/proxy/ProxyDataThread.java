...
class ProxyDataThread implements Runnable {
    ...
    public ProxyDataThread(final Socket clientDataSocket, final Control parent, final CacheMain cache, final boolean realtime) throws IOException {
        ...
        do {
            Proxy.sleep(250);
        } while (sm.getTypes().size() < 1); //wait for scaling info
    ...
    public synchronized void disconnect() throws IOException {
        ...
        this.clientDataIn = null;
        this.clientDataOut.close();
        this.clientDataOut = null;
        this.clientDataSocket.close();
        this.clientDataSocket = null;
    ...
    public /*NOT synchronized*/ void run() {
        try {
            ...
            if (this.parent != null) try {
                this.parent.killConnection(this);
            } catch (IOException ioe2) {
                throw new Error(ioe2);
            }
            ioe.printStackTrace();
        }
    }
