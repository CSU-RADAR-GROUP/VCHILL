...
public class WindowManager
{
    ...
    {
        this.ascopeWidth = width; this.ascopeHeight = height;
    ...
    public synchronized int getPlotWindowHeight () { return this.plotHeight; }

    public synchronized void setPlotDividerLocation (final int plotDivider) {
        this.plotDivider = plotDivider; }
    public synchronized int getPlotDividerLocation () { return this.plotDivider; }
    ...
    private synchronized JInternalFrame createWindow (final ViewWindow win, final int width, final int height)
    {
        ...
        switch (numWins % 4) { //set the upper left corner's position
            case 0: frame.setLocation(offset, offset); break;
            case 1: frame.setLocation(desktop.getWidth() - width - offset, desktop.getHeight() - height - offset); break;
            case 2: frame.setLocation(desktop.getWidth() - width - offset, offset); break;
            case 3: frame.setLocation(offset, desktop.getHeight() - height - offset); break;
        }
