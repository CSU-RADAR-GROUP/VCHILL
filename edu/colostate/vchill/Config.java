...
public class Config
{
    ...
    public boolean isGridEnabled () { return this.drawGrid; }
    ...
    public boolean isClickPointEnabled () { return this.drawClickpt; }
    ...
    public boolean isMapEnabled () { return this.drawMap; }
    ...
    public boolean isAircraftEnabled () { return this.drawAircraft; }
    ...
    public boolean isThresholdEnabled () { return this.useThreshold; }
    ...
    public synchronized String getThresholdType () { return this.thresholdType; }
    ...
    public synchronized double getThresholdFilterCutoff () { return this.thresholdFilterCutoff; }
    ...
    public synchronized boolean isThresholdAbsoluteValue () { return this.thresholdIsAbsoluteValue; }
    ...
    public synchronized boolean isThresholdGreaterThan () { return this.thresholdIsGreaterThan; }
    ...
    public boolean isSmoothingEnabled () { return this.useSmoothing; }
    ...
    public boolean isNoiseReductionEnabled () { return this.reduceNoise; }
    ...
    public boolean isUnfoldingEnabled () { return this.unfoldVelocities; }
    ...
    public boolean isUnfoldingAutomatic () { return this.unfoldingAutomatic; }
	...
	public double getUnfoldStartRange () { return this.unfoldStartRange; }
    ...
    public int getClutterWindowSize () { return this.clutterWindowSize; }
    public double getClutterThreshold () { return this.clutterThreshold; }
    ...
    public synchronized void setRHIHVFactor (final String rhiHvFactor) {
        try { this.setRHIHVFactor(Double.parseDouble(rhiHvFactor)); } catch (NumberFormatException nfe) { System.err.println("Ignoring badly formatted RHI HV factor"); }}
    public synchronized double getRHIHVFactor () { return this.rhiHvFactor; }
    ...
    public synchronized String getDefaultDirName () { return this.directoryName; }
    ...
    public synchronized String getDefaultSocketName () { return this.socketName; }
    ...
    public synchronized String getDefaultControlName () { return this.controlName; }
    ...
    public synchronized String getDefaultRealtimeName () { return this.realtimeName; }
    ...
    public synchronized Mode getPlottingMode () { return this.plottingMode; }

    public int getDefaultImageSizeX () { return 512; }
    public int getDefaultImageSizeY () { return 512; }

    public int getDefaultImageMax () { return this.imageBufferSize; }
    ...
    public synchronized void setRayStep (final String rayStep) {
        try { this.setRayStep((int)Double.parseDouble(rayStep)); }
        catch (NumberFormatException nfe) { System.err.println("Ignoring badly formatted ray step"); }}
    public synchronized int getRayStep () { return this.rayStep; }
    ...
    public void setPlotRange (final String plotRange) {
        try { this.setPlotRange(Double.parseDouble(plotRange)); }
        catch (NumberFormatException nfe) { System.err.println("Ignoring badly formatted max plot range"); }}
    public synchronized double getPlotRange () { return this.plotRange; }
    ...
    public synchronized double getMaxPlotRange () { return this.maxPlotRange; }
    ...
    public synchronized void setMaxPlotHeight (final String maxPlotHeight) {
        try { this.setMaxPlotHeight(Double.parseDouble(maxPlotHeight)); }
        catch (NumberFormatException nfe) { System.err.println("Ignoring badly formatted max plot height"); }}
    public synchronized double getMaxPlotHeight () { return this.maxPlotHeight; }
    ...
    public synchronized void setGridSpacing (final String gridSpacing) {
        try { this.setGridSpacing((int)Double.parseDouble(gridSpacing)); }
        catch (NumberFormatException nfe) { System.err.println("Ignoring badly formatted grid spacing"); }}
    public synchronized int getGridSpacing () { return this.gridSpacing; }
    ...
    public synchronized void setCenterX (final String centerX) {
        try { this.setCenterX(Double.parseDouble(centerX)); }
        catch (NumberFormatException nfe) { System.err.println("Ignoring badly formatted center x"); }}
    public synchronized double getCenterX() { return this.centerX; }
    ...
    public synchronized void setCenterY (final String centerY) {
        try { this.setCenterY(Double.parseDouble(centerY)); }
        catch (NumberFormatException nfe) { System.err.println("Ignoring badly formatted center y"); }}
    public synchronized double getCenterY() { return this.centerY; }

    public synchronized void setImageAutosaveEnabled (final boolean autosave) {
        this.autosave = autosave; }
    public synchronized boolean isImageAutosaveEnabled () { return this.autosave; }

    public synchronized void setImageAutoExportEnabled (final boolean autoexport) {
        this.autoexport = autoexport; }
    public synchronized boolean isImageAutoExportEnabled () { return this.autoexport; }

    public synchronized void setSaveToDiskEnabled (final boolean saveToDisk) {
        this.saveToDisk = saveToDisk; }
    public synchronized boolean isSaveToDiskEnabled () { return this.saveToDisk; }

    public synchronized void setSaveToDiskPath (final String saveToDiskPath) {
        this.saveToDiskPath = saveToDiskPath; }
    public synchronized String getSaveToDiskPath () { return this.saveToDiskPath; }

    public synchronized void setSaveAllEnabled (final boolean saveAll) {
        this.saveAll = saveAll; }
    public synchronized boolean isSaveAllEnabled () { return this.saveAll; }

    public synchronized void setAutosaveTilt (final int saveTilt) {
        this.saveTilt = saveTilt; }
    public synchronized int getAutosaveTilt () { return this.saveTilt; }

    public synchronized void setScanFilter (final String scanFilter) {
        this.scanFilter = scanFilter; }
    public synchronized String getScanFilter () { return this.scanFilter; }

    public synchronized void setGUIEnabled (final boolean useGUI) {
        this.useGUI = useGUI; }
    public synchronized boolean isGUIEnabled () { return this.useGUI; }

    public NumberFormat getNumberFormat () { return this.nf; }

    public synchronized void setSignon (final String signon) {
        this.signon = signon; }
    public synchronized String getSignon() { return this.signon; }

    public synchronized void setPassword (final String password) {
        this.password = password; }
    public synchronized String getPassword() { return this.password; }

    public synchronized void setRealtimeModeEnabled (final boolean realtimeMode) {
        this.realtimeMode = realtimeMode; }
    public synchronized boolean isRealtimeModeEnabled () { return this.realtimeMode; }
	...
	public synchronized int getLastConnectionType () { return this.lastConnectionType; }
